<?php
/**
*    MODULE HELPCHAT POUR DOLIBARR - v.1.0
*    Copyright (C) 2017 - JOFFREY LETUVE <joffrey.letuve@arexys.com>
...
/**
 * 	\defgroup   helpchat     Module Helpchat
 *  \brief      This modules provides a chat assistance for Dolibarr users
 *  \file       htdocs/helpchat/core/modules/modHelpchat.class.php
 *  \ingroup    helpchat
 *  \brief      This module allows you to receive payment through Helpchat service
 */

include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module Helpchat
 */
class modHelpchat extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		//                        );
		$this->module_parts = array('hooks' => array('leftblock'));
		...
		$this->langfiles = array("helpchat@helpchat");
